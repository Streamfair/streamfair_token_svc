...
func (x *UpdateTokenResponse) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
var file_token_rpc_update_token_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xad, 0x01, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x6f,
	...
	0x73, 0x41, 0x74, 0x22, 0x66, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x6b,
	...
	0x52, 0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x42, 0x35, 0x5a, 0x33, 0x67,
...
var file_token_rpc_update_token_proto_depIdxs = []int32{
	2, // 0: pb.UpdateTokenRequest.expires_at:type_name -> google.protobuf.Timestamp
	2, // 1: pb.UpdateTokenResponse.expires_at:type_name -> google.protobuf.Timestamp
