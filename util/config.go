...
func LoadConfig() (config Config, err error) {
	...
	keys := []string{
		"SERVER_NAME",
		"DB_SOURCE_TOKEN_SERVICE",
		"DB_SOURCE_TOKEN_SERVICE_LOCAL",
		"MIGRATION_URL",
		"HTTP_SERVER_ADDRESS_TOKEN_SERVICE",
		"GRPC_SERVER_ADDRESS_TOKEN_SERVICE",
		"TOKEN_SYMMETRIC_KEY",
	...
	config.DBSource = viper.GetString("DB_SOURCE_TOKEN_SERVICE")
	config.DBSourceLocal = viper.GetString("DB_SOURCE_TOKEN_SERVICE_LOCAL")
	config.MigrationURL = viper.GetString("MIGRATION_URL")
	config.HttpServerAddress = viper.GetString("HTTP_SERVER_ADDRESS_TOKEN_SERVICE")
	config.GrpcServerAddress = viper.GetString("GRPC_SERVER_ADDRESS_TOKEN_SERVICE")
...
func setConfigValue(config *Config, key string, value string) error {
	...
	case "DB_SOURCE_TOKEN_SERVICE":
		config.DBSource = value
	case "DB_SOURCE_TOKEN_SERVICE_LOCAL":
		config.DBSourceLocal = value
	case "MIGRATION_URL":
		config.MigrationURL = value
	case "HTTP_SERVER_ADDRESS_TOKEN_SERVICE":
		config.HttpServerAddress = value
	case "GRPC_SERVER_ADDRESS_TOKEN_SERVICE":
